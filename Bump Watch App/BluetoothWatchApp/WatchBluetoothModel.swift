...
class WatchBluetoothModel: NSObject, ObservableObject {
    ...
    private func retrievePeripheral() {
        ...
        if let connectedPeripheral = connectedPeripherals.last {
            ...
            centralManager?.scanForPeripherals(withServices: [WatchTransferService.serviceUUID],
    ...
    private func cleanup() {
        ...
        for service in (discoveredPeripheral.services ?? [] as [CBService]) {
            for characteristic in (service.characteristics ?? [] as [CBCharacteristic]) {
                if characteristic.uuid == WatchTransferService.characteristicUUID && characteristic.isNotifying {
...
extension WatchBluetoothModel: CBCentralManagerDelegate {
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        peripheral.discoverServices([WatchTransferService.serviceUUID])
    }
...
extension WatchBluetoothModel: CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral, didModifyServices invalidatedServices: [CBService]) {
        ...
        for service in invalidatedServices where service.uuid == WatchTransferService.serviceUUID {
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        for service in peripheralServices {
            peripheral.discoverCharacteristics([WatchTransferService.characteristicUUID], for: service)
        }
    }
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        for characteristic in serviceCharacteristics where characteristic.uuid == WatchTransferService.characteristicUUID {
    ...
    func peripheral(_ peripheral: CBPeripheral, didUpdateNotificationStateFor characteristic: CBCharacteristic, error: Error?) {
        ...
        guard characteristic.uuid == WatchTransferService.characteristicUUID else { return }
